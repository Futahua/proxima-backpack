...
export function renderScheduleNavigation(
  ...
  return `<div class="calendar-controls" data-schedule-navigation="true" data-schedule-navigation-mode="${mode}" data-schedule-navigation-date="${localDateKey(cursor)}"><button type="button" class="icon-button" data-action="schedule-navigate" data-direction="previous" data-c1-key="schedule-previous" aria-label="Previous ${mode}">←</button><button type="button" class="icon-button" data-action="schedule-navigate" data-direction="today" data-c1-key="schedule-today">Today</button><strong data-c1-key="schedule-navigation-label">${label}</strong><button type="button" class="icon-button" data-action="schedule-navigate" data-direction="next" data-c1-key="schedule-next" aria-label="Next ${mode}">→</button></div>`;
}
