...
const canvasDropQueue = createCanvasDropQueue(DETERMINISTIC_IDS, EMPTY_CANVAS_SURFACE, canvasPreviewRegistry, canvasExcalidrawPreviewRegistry);
...
function bindInteractions(): void {
  ...
  window.addEventListener('pagehide', (event) => { disposeCanvasPreviewsOnPageHide(event, canvasPreviewRegistry); disposeCanvasExcalidrawPreviewsOnPageHide(event, canvasExcalidrawPreviewRegistry); });
}
